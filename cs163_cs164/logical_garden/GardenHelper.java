...
addPlant
public boolean addPlant(String plantName,
 int row)
...
canPlant
public boolean canPlant(String plantName,
 GardenRow row)
...
public class GardenHelper {
    ...
    public boolean addPlant(String plantName, int row) {
        if(row == 1) {
            if(canPlant(plantName, one)) {
                one.setPlant(searchPlant(plantName));
                return true;
            }
        }
        else if(row == 2) {
            if(canPlant(plantName, two)) {
                two.setPlant(searchPlant(plantName));
                return true;
            }
        }
        else if(row == 3) {
            if(canPlant(plantName, three)) {
                three.setPlant(searchPlant(plantName));
                return true;
            }
        }
